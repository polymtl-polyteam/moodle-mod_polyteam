...
class mbti_form extends \moodleform {
    ...
    public function definition() {
        ...
        // The edit flag is used to display the form in read-only (when the user didn't click 'fill in questionnaire' or when the questionnaire is expired).
        $mform->addElement('hidden', 'edit', $this->_customdata['edit']); // Ugly workaround because disabledIf only test conditions on form elements.
